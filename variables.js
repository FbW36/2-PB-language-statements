...
//console.log (lastName); //console.log(lastName)
...
console.log (typeof '1000'); // ==> string because it is between " " 
...
console.log (person, city, age2);
// '1`+ '1' = '11'
console.log ("Hallo my name is " + person + ". I live in " + city2+ ". I am " +age2 + " years old.");

let str1 = "First string ";
let str2 = "Second string";

let str3 = str1 + str2;
let str4 = "Tom " + 27; //=> Tom 27
let str5 ="1" +'1'; //=> '11'
...
let oddNum = 43;
console.log ("is odd ==> ", oddNum % 2 == 0); //is even ==> false
